class FriendshipsController < ApplicationController
  before_action :current_user_must_be_friendship_receiver, :only => [:show, :edit_form, :update_row, :destroy_row]

  def current_user_must_be_friendship_receiver
  ...
  before_action :current_user_must_be_friendship_sender, :only => [:show, :edit_form, :update_row, :destroy_row]
